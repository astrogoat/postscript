...
/*
 ...
 | -----------------------------------------------
 | Using your view with mix('css/postscript.css', 'vendor/postscript')
...
// mix
    // .postCss('resources/css/postscript.css', 'css', [require('tailwindcss')('tailwind.config.js')])
    // .js('resources/js/postscript.js', 'js')
    // .version()
